...
function Home() {
    ...
    return(
        ...
        <div>
            ...
            <div class="image-container">
            <p>"A family bound together across generations, sharing the love and peace at each gathering, celebrating the togetherness that was instilled by those who came before and cherished by those who come after."</p>
